...
public class CoordsCommand extends HelpfulCommandsCommand {
    ...
    private int execute(CommandContext<CommandSourceStack> ctx) throws CommandSyntaxException {
        ...
        componentBuilder.appendTranslatable("commands.helpfulcommands.coords.self", StylingUtil.getLocationText(sourcePlayer.position(), dimensionKey));
    ...
    private int broadcast(CommandContext<CommandSourceStack> ctx, ServerPlayer player) throws CommandSyntaxException {
        ...
        for (ServerPlayer plr : playerList) {
            ...
            componentBuilder.appendTranslatable("commands.helpfulcommands.coords.other", StylingUtil.getAffectedEntityNameText(player), StylingUtil.getLocationText(player.position(), dimensionKey));
    ...
    private int share(CommandContext<CommandSourceStack> ctx, Collection<ServerPlayer> players) throws CommandSyntaxException {
        ...
        for (ServerPlayer player : playerList) {
            ...
            componentBuilder.appendTranslatable("commands.helpfulcommands.coords.share.affected", StylingUtil.getAffectedEntityNameText(sourcePlayer), StylingUtil.getLocationText(sourcePlayer.position(), dimensionKey));
        ...
        if (playerList.size() == 1) {
            ...
            affected
                    ...
                    .append(TranslationManager.translate(src, "commands.helpfulcommands.coords.share.multiple"));
        }

        componentBuilder.appendTranslatable("commands.helpfulcommands.coords.share.other", affected);
