...
public class HcCommand extends HelpfulCommandsCommand {
    private static final Dynamic2CommandExceptionType INVALID_HC_COMMAND = new Dynamic2CommandExceptionType((src, commandName) ->
            new ComponentBuilder((CommandSourceStack) src).appendTranslatable("commands.helpfulcommands.hc.config.command.error.invalid_hc_command", Component.literal(commandName.toString()).setStyle(StylingManager.getCurrentStyle().getTextStyles().getPrimary())).build()
    );
    private static final Dynamic2CommandExceptionType COMMAND_NOT_CONFIGURABLE = new Dynamic2CommandExceptionType((src, commandName) ->
            new ComponentBuilder((CommandSourceStack) src).appendTranslatable("commands.helpfulcommands.hc.config.command.error.command_not_configurable", Component.literal(commandName.toString()).setStyle(StylingManager.getCurrentStyle().getTextStyles().getPrimary())).build()
    );
    private static final DynamicCommandExceptionType NO_ACTIVE_COOLDOWNS_FOUND = new DynamicCommandExceptionType((src) ->
            new ComponentBuilder((CommandSourceStack) src).appendTranslatable("commands.helpfulcommands.hc.cooldowns.error.no_active_cooldowns_found").build()
    );
    ...
    private int about(CommandContext<CommandSourceStack> ctx) {
        ...
        HoverEvent linkHoverEvent = new HoverEvent.ShowText(Component.literal(TranslationManager.translate(src, "helpfulcommands.hover.click_to_open_link")));

        Component quickActionCommandListBtn = StylingUtil.getButton("\uD83D\uDCC3", Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.about.actions.command_list")), new HoverEvent.ShowText(Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.about.hover.command_list"))), new ClickEvent.RunCommand("/hc commands"));
        Component quickActionConfigureBtn = StylingUtil.getButton("\uD83D\uDD27", Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.about.actions.config")), new HoverEvent.ShowText(Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.about.hover.config"))), new ClickEvent.RunCommand("/hc config"));
        ...
        if (isPlayer) {
            ...
            docsComponent = Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.about.docs")).setStyle(textStyles.getSecondary().withUnderlined(true).withHoverEvent(linkHoverEvent).withClickEvent(new ClickEvent.OpenUrl(URI.create(docsLink))));
            ...
            docsComponent = Component.literal("\n" + TranslationManager.translate(src, "commands.helpfulcommands.hc.about.docs")).append(": %s".formatted(docsLink));
        ...
        componentBuilder
                .appendComponent(StylingUtil.getTitle(Component.literal("Helpful Commands"), Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.about.title"))))
                .appendNewline()
                .appendWhitespace()
                .appendTranslatable("modmenu.descriptionTranslation.helpfulcommands")
                .appendNewline()
                .appendNewline()
                .appendComponent(Component.literal(textDecorators.getBulletPoint()).setStyle(textStyles.getTertiary()))
                .appendComponent(Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.about.version")).setStyle(textStyles.getTertiary()))
                .appendWhitespace()
                .appendComponent(Component.literal(Services.PLATFORM.getModVersion()).setStyle(textStyles.getSecondary()))
                .appendNewline()
                .appendComponent(Component.literal(textDecorators.getBulletPoint()).setStyle(textStyles.getTertiary()))
                .appendComponent(Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.about.author")).setStyle(textStyles.getTertiary()))
                .appendWhitespace()
                .appendComponent(authorComponent)
                .appendNewline()
                .appendNewline()
                .appendComponent(Component.literal(textDecorators.getBulletPoint()).setStyle(textStyles.getTertiary()))
                .appendComponent(Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.about.links")).setStyle(textStyles.getTertiary()))
                .appendWhitespace()
                ...
                .appendNewline()
                .appendComponent(Component.literal(textDecorators.getBulletPoint()).setStyle(textStyles.getTertiary()))
                .appendComponent(Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.about.actions")).setStyle(textStyles.getTertiary()));
        ...
        if (isPlayer) {
            ...
            componentBuilder
                    .appendNewline()
                    .appendTranslatable("commands.helpfulcommands.hc.about.actions.command_list")
                    .appendLiteral(": /hc commands")
                    .appendNewline()
                    .appendTranslatable("commands.helpfulcommands.hc.about.actions.config")
    ...
    private int commandList(CommandContext<CommandSourceStack> ctx, CommandDispatcher<CommandSourceStack> dispatcher, Boolean showAll) {
        ...
        ComponentBuilder componentBuilder = new ComponentBuilder(src);
        componentBuilder.appendComponent(StylingUtil.getTitle(Component.literal("Helpful Commands"), Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.commandList.title"))));
    ...
    private int commandListAll(CommandContext<CommandSourceStack> ctx, CommandDispatcher<CommandSourceStack> dispatcher, ComponentBuilder componentBuilder) {
        ...
        for (Map.Entry<ModCommandManager.CommandCategory, List<HelpfulCommandsCommand>> entry : ModCommandManager.getCommandListByCategory().entrySet()) {
            ...
            componentBuilder.appendNewline().appendComponent(Component.literal(textDecorators.getCategoryStartingChar()).setStyle(categoryStyle)).appendComponent(Component.literal(TranslationManager.translate(src, "helpfulcommands.command_category.%s".formatted(entry.getKey().toString().toLowerCase()))).setStyle(categoryStyle));
    ...
    private int commandListAvailableOnly(CommandContext<CommandSourceStack> ctx, CommandDispatcher<CommandSourceStack> dispatcher, ComponentBuilder componentBuilder) {
        ...
        componentBuilder
                ...
                .appendComponent(Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.commandList.available_only")).setStyle(textStyles.getWarning()))
                .appendWhitespace()
                .appendComponent(StylingUtil.getButton(Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.commandList.available_only.show_all")), textStyles.getButton().withClickEvent(new ClickEvent.RunCommand("/hc commands true"))))
                .appendNewline();
    ...
    private HoverEvent getCommandHoverEvent(CommandSourceStack src, CommandDispatcher<CommandSourceStack> dispatcher, HelpfulCommandsStyle.TextStyles textStyles, HelpfulCommandsCommand command, boolean hasPerms, boolean enabled) {
        ...
        if (canUse) {
            ...
            componentBuilder
                    .appendNewline()
                    .appendNewline()
                    .appendComponent(Component.literal(TranslationManager.translate(src,"commands.helpfulcommands.hc.commandList.cant_use")).setStyle(textStyles.getUnavailable()))
                    .appendWhitespace()
                    .appendComponent(Component.literal(TranslationManager.translate(src, !enabled ? "helpfulcommands.error.command.disabled" : "helpfulcommands.error.command.not_allowed").toLowerCase()).setStyle(textStyles.getUnavailable()));
        }
    ...
    private HoverEvent getCommandStateHoverEvent(CommandSourceStack source, HelpfulCommandsStyle.TextStyles textStyles, String commandName, boolean currentState) {
        ...
        componentBuilder
                .appendComponent(Component.literal(TranslationManager.translate(source, "helpfulcommands.common." + (currentState ? "enabled" : "disabled"))).setStyle(currentState ? textStyles.getEnabled() : textStyles.getDisabled()))
                .appendNewline()
                .appendNewline()
                .appendTranslatable("commands.helpfulcommands.hc.commandList.click_to_toggle_command", Component.literal(TranslationManager.translate(source, "commands.helpfulcommands.hc.commandList.click_to_toggle_command." + String.valueOf(currentState).toLowerCase())), Component.literal("/" + commandName).setStyle(textStyles.getPrimary()));
    ...
    private int config(CommandContext<CommandSourceStack> ctx) {
        ...
        componentBuilder.appendComponent(StylingUtil.getTitle(Component.literal("Helpful Commands"), Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.config.title"))));
        ...
        if (commandConfig) {
            componentBuilder
                    ...
                    .appendComponent(Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.config.command.title")).setStyle(textStyles.getTertiary()))
                    .appendNewline()
                    .appendWhitespace()
                    .appendTranslatable("commands.helpfulcommands.hc.config.command.description", Component.literal("/hc config command").setStyle(textStyles.getSecondary().withClickEvent(new ClickEvent.SuggestCommand("/hc config command ")).withHoverEvent(new HoverEvent.ShowText(Component.literal(TranslationManager.translate(src, "helpfulcommands.hover.click_to_paste_command"))))));
            if (isPlayer) {
        ...
        if (PermissionsUtil.hasPermission(src, ModPermissions.Permission.COMMAND_HC_CONFIG_FIELD) && singleplayerOwnerCheck(src)) {
            ...
            if (isPlayer) {
                ...
                Component btn = StylingUtil.getButton(Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.config.field.title")), btnStyle);
                componentBuilder
                        .appendComponent(btn)
                        .appendNewline()
                        .appendWhitespace()
                        .appendTranslatable("commands.helpfulcommands.hc.config.field.description");
            } else {
                componentBuilder
                        .appendComponent(Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.config.field.title")).setStyle(textStyles.getTertiary()))
                        .appendNewline()
                        .appendWhitespace()
                        .appendTranslatable("commands.helpfulcommands.hc.config.field.description.use", Component.literal("/hc config field").setStyle(textStyles.getSecondary().withClickEvent(new ClickEvent.SuggestCommand("/hc config field ")).withHoverEvent(new HoverEvent.ShowText(Component.literal(TranslationManager.translate(src, "helpfulcommands.hover.click_to_paste_command"))))))
                        .appendNewline()
                        .appendWhitespace()
                        .appendTranslatable("commands.helpfulcommands.hc.config.field.description");
            }
    ...
    private int configField(CommandContext<CommandSourceStack> ctx) {
        ...
        ComponentBuilder componentBuilder = new ComponentBuilder(src);
        componentBuilder.appendComponent(StylingUtil.getTitle(Component.literal("Helpful Commands"), Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.config.field.title"))));
        ...
        for (ConfigManager.CONFIG_FIELD configField : ConfigManager.CONFIG_FIELD.values()) {
            ...
            fieldNameComponentBuilder
                    ...
                    .appendNewline()
                    .appendLiteral(TranslationManager.translate(src, "%s.config_field.%s.description".formatted(Constants.MOD_ID, name)))
                    .appendNewline()
                    .appendNewline()
                    .appendComponent(Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.config.field.default_value")).setStyle(textStyles.getSubtle()))
                    .appendWhitespace()
            ...
            if (isPlayer) {
                ...
                HoverEvent resetBtnHoverEvent = new HoverEvent.ShowText(Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.config.field.hover.click_to_reset")));
            ...
            if (luckPermsAvailable && configField.lpMetaSupport()) {
                String metaPermId = "meta.%s_%s.(value)".formatted(Constants.MOD_SHORT_ID, name);
                ...
                metaComponentBuilder
                        .appendComponent(Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.config.field.lp_meta")).setStyle(lpStyle))
                        .appendNewline()
                        .appendTranslatable("commands.helpfulcommands.hc.config.field.lp_meta.permission_id", Component.literal(metaPermId).setStyle(textStyles.getPrimary()))
                        .appendNewline()
                        .appendNewline()
                        .appendComponent(Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.config.field.lp_meta.fallback")).setStyle(textStyles.getSubtle()));
    ...
    private int setCommandState(CommandContext<CommandSourceStack> ctx, String command, boolean newState) throws CommandSyntaxException {
        ...
        if (config.setCommandState(command, newState)) {
            ComponentBuilder componentBuilder = new ComponentBuilder(src);
            componentBuilder.appendTranslatable("commands.helpfulcommands.hc.config.command.state.set", Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.config.command.state." + String.valueOf(newState).toLowerCase())), Component.literal("/" + command).setStyle(textStyles.getPrimary()));
    ...
    private int queryCommandState(CommandContext<CommandSourceStack> ctx, String command) throws CommandSyntaxException {
        ...
        ComponentBuilder componentBuilder = new ComponentBuilder(src);
        componentBuilder.appendTranslatable("commands.helpfulcommands.hc.config.command.state.query", Component.literal("/" + command).setStyle(textStyles.getPrimary()), Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.config.command.state." + String.valueOf(state).toLowerCase()).toLowerCase()));
    ...
    private int setConfigField(CommandContext<CommandSourceStack> ctx, String field, Object newValue) {
        ...
        ComponentBuilder componentBuilder = new ComponentBuilder(src);
        componentBuilder.appendTranslatable("commands.helpfulcommands.hc.config.field.set", Component.literal(field).setStyle(textStyles.getPrimary()), Component.literal(String.valueOf(newValue)).setStyle(textStyles.getPrimary()));
    ...
    private int queryConfigField(CommandContext<CommandSourceStack> ctx, String field) {
        ...
        ComponentBuilder componentBuilder = new ComponentBuilder(src);
        componentBuilder.appendTranslatable("commands.helpfulcommands.hc.config.field.query", Component.literal(field).setStyle(textStyles.getPrimary()), Component.literal(String.valueOf(value)).setStyle(textStyles.getPrimary()));
        componentBuilder.setStyle(textStyles.getSuccess());
    ...
    private int clearCooldown(CommandContext<CommandSourceStack> ctx, CooldownManager.CooldownType cooldownType, Collection<ServerPlayer> players) throws CommandSyntaxException {
        ...
        ComponentBuilder componentBuilder = new ComponentBuilder(src);
        componentBuilder.appendTranslatable("commands.helpfulcommands.hc.cooldowns.clear", Component.literal(String.valueOf(removed)).setStyle(textStyles.getPrimary()), Component.literal(TranslationManager.translate(src, "commands.helpfulcommands.hc.cooldowns.clear." + (removed == 1 ? "single" : "multiple"))));
        componentBuilder.setStyle(textStyles.getSuccess());
