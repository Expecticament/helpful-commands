...
import com.expecticament.helpful_commands.manager.HomeManager;
...
public class HomeNameSuggestionProvider implements SuggestionProvider<CommandSourceStack> {
    ...
    public CompletableFuture<Suggestions> getSuggestions(CommandContext<CommandSourceStack> context, SuggestionsBuilder builder) {
        ...
        if (player != null) {
            for (Map.Entry<String, HomeManager.Home> entry : HomeManager.getHomesForPlayer(player).entrySet()) {
