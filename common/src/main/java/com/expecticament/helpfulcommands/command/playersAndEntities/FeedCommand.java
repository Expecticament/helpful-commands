...
public class FeedCommand extends HelpfulCommandsCommand {
    ...
    public void register(CommandDispatcher<CommandSourceStack> dispatcher, CommandBuildContext buildContext, Commands.CommandSelection commandSelection) {
        ...
        dispatcher.register(Commands.literal(modCommand.getName())
                ...
                .then(Commands.argument("players", EntityArgument.players())
                        .requires(src -> PermissionsUtil.hasPermission(src, ModPermissions.Permission.COMMAND_FEED_OTHERS))
    ...
    protected boolean checkBaseCommandRequirements(CommandSourceStack source) {
        return PermissionsUtil.hasPermission(source, ModPermissions.Permission.COMMAND_FEED);
    }
    ...
    private int executeSelf(CommandContext<CommandSourceStack> ctx) throws CommandSyntaxException {
        ...
        componentBuilder.appendTranslatable("commands.helpfulcommands.feed.self");
    ...
    private int executeOther(CommandContext<CommandSourceStack> ctx, Collection<ServerPlayer> players) throws CommandSyntaxException {
                ...
                .peek(player -> {
                    if (commandFeedback) {
                        if (player != sourcePlayer) {
                            ...
                            componentBuilder.appendTranslatable("commands.helpfulcommands.feed.affected").setStyle(textStyles.getAffectedPositive());
        ...
        if (affected.size() == 1) {
            ...
            affectedText
                    ...
                    .append(" ")
                    .append(TranslationManager.translate(src, "commands.helpfulcommands.feed.other.multiple"));
        }

        ComponentBuilder componentBuilder = new ComponentBuilder(src);
        componentBuilder.appendTranslatable("commands.helpfulcommands.feed.other", affectedText).setStyle(textStyles.getSuccess());
