...
public class ExtinguishCommand extends HelpfulCommandsCommand {
    ...
    private int executeSelf(CommandContext<CommandSourceStack> ctx) throws CommandSyntaxException {
        ...
        componentBuilder.appendTranslatable("commands.helpfulcommands.extinguish.self");
    ...
    private int executeOther(CommandContext<CommandSourceStack> ctx, Collection<? extends Entity> entities) throws CommandSyntaxException {
                ...
                .peek(entity -> {
                    if (entity.isAlwaysTicking() && commandFeedback) {
                        ...
                        if (player != sourcePlayer) {
                            ...
                            componentBuilder.appendTranslatable("commands.helpfulcommands.extinguish.affected").setStyle(textStyles.getAffectedPositive());
        ...
        if (affected.size() == 1) {
            ...
            affectedText
                    ...
                    .append(" ")
                    .append(TranslationManager.translate(src, "commands.helpfulcommands.extinguish.other.multiple"));
        }

        ComponentBuilder componentBuilder = new ComponentBuilder(src);
        componentBuilder.appendTranslatable("commands.helpfulcommands.extinguish.other", affectedText).setStyle(textStyles.getSuccess());
