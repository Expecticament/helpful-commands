...
public class GmCommand extends HelpfulCommandsCommand {
    ...
    private int executeSelf(CommandContext<CommandSourceStack> ctx, GameType gameType) throws CommandSyntaxException {
        ...
        componentBuilder.appendTranslatable("commands.helpfulcommands.gm.self", Component.translatable("gameMode." + gameType.getName()).setStyle(textStyles.getPrimary()));
    ...
    private int executeOther(CommandContext<CommandSourceStack> ctx, GameType gameType, Collection<ServerPlayer> players) throws CommandSyntaxException {
                ...
                .peek(player -> {
                    if (commandFeedback) {
                        if (player != sourcePlayer) {
                            ...
                            componentBuilder.appendTranslatable("commands.helpfulcommands.gm.affected", gameModeNameComponent).setStyle(textStyles.getAffectedNeutral());
        ...
        if (affected.size() == 1) {
            ...
            affectedText
                    ...
                    .append(" ")
                    .append(TranslationManager.translate(src, "commands.helpfulcommands.gm.other.multiple"));
        }

        ComponentBuilder componentBuilder = new ComponentBuilder(src);
        componentBuilder.appendTranslatable("commands.helpfulcommands.gm.other", gameModeNameComponent, affectedText).setStyle(textStyles.getSuccess());
